...
GST1_FSL_PLUGINS_VERSION = 4.0.8
GST1_FSL_PLUGINS_SOURCE = gst1.0-fsl-plugins-$(GST1_FSL_PLUGINS_VERSION).tar.gz
...
#GST1_FSL_PLUGINS_POST_PATCH_HOOKS += GST1_FSL_PLUGINS_PATCH_M4
